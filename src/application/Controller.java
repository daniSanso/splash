...
//cuando ya ha subido el primnero subimos el siguiete
            translateTransition1.setOnFinished(event1 -> {

//hacemos visible y subimos
 ...
 //cuando ya ha subido el segundo subimos el siguiete
...
//hacemos visible el pane final(spinner y label)
                    translateTransition111.setOnFinished(event3 -> {
                        ...
                        fadeTransition.setFromValue(0);//fade de 0 a 1(maximo y minimo) para que vaya apareciendo poco a poco
                        fadeTransition.setToValue(1);
                        fadeTransition.play();
//difuminamos todo al finalizar(es un spash)
                        fadeTransition.setOnFinished(event4 -> {
//cuando ha terminado el efecto de irse se cierra la ventana
